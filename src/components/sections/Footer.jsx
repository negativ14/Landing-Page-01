...
function Footer() {
    return <footer className="bg-gradient-to-bottom -mt-1 ">
        <div className="m-auto flex max-w-[90rem] justify-between px-24 py-32">
            <div>
                <a href="#" className="flex items-center gap-x-3">
                    <Logo className="stroke-primary-500" width={4.5} alt="Noteflow logo"/>
                    <p className="text-primary-50 text-xl font-bold traccking-tight">NoteFlow</p>
                </a>
            </div>
