  ...
  return (
    <nav className="text-primary-50 m-auto flex max-w-[90rem] justify-between px-24 text-lg/8 font-light">
      ...
      <div className="flex items-center gap-x-3">
        ...
        <button className="bg-primary-500 border-primary-500 text-primary-1300 hover:bg-primary-50 hover:border-primary-50 transition-properties primary-glow primary-glow-hover cursor-pointer rounded-full border-2 px-8 py-3.5 text-lg/8 font-normal">
          Get Started
        </button>
      </div>
    </nav>
